...
var useSpecificForm = function useSpecificForm(name, _ref) {
  ...
  var onChange = function onChange(event) {
    ...
    setInputs(function (inputs) {
      currentInputs = _objectSpread({}, inputs, _defineProperty({}, event.target.name, event.target.value)); // if(!event.target.value) delete currentInputs[event.target.name]
  ...
  var setInput = function setInput(values) {
    setInputs(function (inputs) {
      return _objectSpread({}, inputs, values);
    });
    if (debug) console.log({
      name: name,
      event: 'setInput',
...
var Form = function Form() {
  var _useForm = (0, _index.default)('sampleForm', {
    initialValues: {
      'name': ''
    },
  ...
  return _react.default.createElement("div", null, _react.default.createElement("div", null, "Hello ", inputs.name), _react.default.createElement("form", {
    onSubmit: onSubmit
