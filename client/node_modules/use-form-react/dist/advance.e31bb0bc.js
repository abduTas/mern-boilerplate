...
},{"./cjs/react-dom.development.js":"../../node_modules/react-dom/cjs/react-dom.development.js"}],"../../src/useForm.js":[function(require,module,exports) {
"use strict";
...
var useForm = function useForm(name, config) {
  var forms = {};
  forms[name] = useSpecificForm(name, config);
  return forms[name];
};

var useSpecificForm = function useSpecificForm(name, _ref) {
  var _ref$initialValues = _ref.initialValues,
      initialValues = _ref$initialValues === void 0 ? {} : _ref$initialValues,
      _ref$debug = _ref.debug,
      debug = _ref$debug === void 0 ? false : _ref$debug,
      _ref$callback = _ref.callback,
      callback = _ref$callback === void 0 ? function (inputs) {
    return console.log('form submitted', inputs);
  } : _ref$callback;
  ...
  var onChange = function onChange(event) {
    ...
    setInputs(function (inputs) {
      currentInputs = _objectSpread({}, inputs, _defineProperty({}, event.target.name, event.target.value));
...
},{"./useForm":"../../src/useForm.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var Form = function Form() {
  ...
  var options = {
    ...
    callback: function callback() {
      return console.log('works!', inputs);
    },
    debug: true
  };
  ...
  var _useForm = (0, _index.default)('AdvanceForm', options),
  ...
  return _react.default.createElement("div", null, error && _react.default.createElement("div", null, "error: ", error), _react.default.createElement("form", {
    onSubmit: onSubmit
  }, _react.default.createElement("h3", null, "Advance Form Demo (", _react.default.createElement("a", {
    href: "https://github.com/amazingandyyy/react-use-form",
    target: "_blank"
  }, "react-use-form"), ")"), _react.default.createElement("input", {
    type: "email",
    name: "email",
    value: inputs.email,
    placeholder: "Email",
    ...
    type: "submit"
  }, "Sign in")), _react.default.createElement("div", null, _react.default.createElement("button", {
    onClick: function onClick() {
      return reset();
    }
  }, "reset"), _react.default.createElement("pre", null, JSON.stringify(inputs, null, 2)), _react.default.createElement("pre", null, JSON.stringify({
    dirty: dirty,
    submitting: submitting
  }, null, 2))));
};

(0, _reactDom.render)(_react.default.createElement(Form, null), document.getElementById('root'));
...
//# sourceMappingURL=/advance.e31bb0bc.js.map